...
const Home = () => {
	return (
		...
		<div className='flex h-screen w-screen rounded-lg overflow-hidden bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 md:p-7 md:m-12'>
			<Sidebar />
			<MessageContainer />
		</div>
